-- ====================================================================
-- FIX DATA PERSISTENCE ISSUES - PROTECTOR.NG (SUPABASE VERSION v3)
-- ====================================================================
-- Fixed with proper UUID type casting and removed non-existent columns
-- ====================================================================
...
-- Fix profiles with NULL critical fields (only fix existing columns)
UPDATE profiles
SET 
