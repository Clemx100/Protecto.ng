...
function HomePageContent() {
  ...
  const handleIOSInstallClick = () => {
    ...
    window.dispatchEvent(new Event("open-ios-install-modal"))
  }
  const handleOpenMobileAppLink = () => {
    if (deviceType === "ios") {
      window.location.href = `x-safari-${REQUEST_WEBSITE}`
      window.setTimeout(() => {
        window.location.href = REQUEST_WEBSITE
      }, 700)
      return
    }

    window.open(REQUEST_WEBSITE, "_blank", "noopener,noreferrer")
  }
  ...
  // Detect current device so the download modal can show relevant actions.
  useEffect(() => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white/10 rounded-xl p-8 border border-white/20">
              ...
              <div className="space-y-4">
                <a
                  href={REGISTER_VEHICLE_WHATSAPP_URL}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-4 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-blue-500/25"
                >
                ...
                <a
                  href={REQUIREMENTS_PDF_URL}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block w-full bg-transparent border-2 border-white/30 hover:border-white text-white font-semibold py-3 px-6 rounded-lg transition-colors"
                >
                  <div className="flex items-center justify-center space-x-2">
            ...
            <div className="space-y-3">
              ...
              {deviceType === "ios" && (
                <button
                  ...
                  className="flex items-center justify-center gap-2 w-full py-3 px-4 bg-slate-700 hover:bg-slate-600 text-white font-medium rounded-lg transition-colors border border-slate-600"
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
              ...
              {deviceType !== "android" && (
                <div className="rounded-lg border border-slate-600 bg-slate-700/40 p-4">
                  <p className="text-xs text-gray-300 mb-3">
                    Installing on iPhone? click Open mobile app link in Safari then tap Share and Add to Home Screen.
                  </p>
                  <div className="mt-3 space-y-2">
                    <button
                      onClick={handleOpenMobileAppLink}
                      className="flex items-center justify-center gap-2 w-full py-2 px-3 bg-slate-600 hover:bg-slate-500 text-white text-sm font-medium rounded-lg transition-colors"
                    >
                    ...
                    <button
                      onClick={handleIOSInstallClick}
                      className="flex items-center justify-center gap-2 w-full py-2 px-3 bg-slate-800 hover:bg-slate-700 text-white text-sm font-medium rounded-lg transition-colors border border-slate-500"
                    >
                      View iPhone install steps
                    </button>
                  </div>
                </div>
              )}
